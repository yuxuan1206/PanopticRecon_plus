...
# scene = "1ada7a0617"
# scene = "bcd2436daf"
base_path = f"/Data/yx/dataset/scannet++/{scene}"
...
img = cv2.imread(os.path.join(base_path, "color/0.jpg"))
...
#     if idx % 1 == 0:
        ...
        color_raw1 = o3d.io.read_image(f"/Data/yx/dataset/scannet++/{scene}/color/{idx}.jpg") #%006d.jpg" % idx
        uint16_img1 = cv2.imread(f'/Data/yx/dataset/scannet++/{scene}/depth/{idx}.png', -1)
        ...
        pose_file = os.path.join(pose_path, file_name.replace('jpg', 'txt'))
...
print(pcd_all)
os.makedirs(f'/home/yx/Data/exp_result/panoptic_recon++/scannetpp/scen_{scene}/0_input_ply', exist_ok=True)
o3d.io.write_point_cloud(f'/home/yx/Data/exp_result/panoptic_recon++/scannetpp/scen_{scene}/0_input_ply/pointcloud_gt_open3d.ply', pcd_all)
