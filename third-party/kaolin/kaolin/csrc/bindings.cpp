...
#include "./smooth_sampler/smooth_sampler.h"

namespace kaolin {

PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  py::module ss = m.def_submodule("smooth_sampler");
  ss.def("forward", &smooth_sampler_forward, "Smooth sampler forward (CUDA)");
  ss.def("backward", &smooth_sampler_backward, "Smooth sampler backward (CUDA)");
  ss.def("backward_backward", &smooth_sampler_backward_backward, "Smooth sampler backward backward (CUDA)");
