...
scene_idx = "0087_02" #"0628_02" #"0088_00" #"0420_01"
scene_name = 'scene'+scene_idx
print(scene_idx)

gt_folder = "/home/yx/Data/dataset/scannet/"+scene_name+"/"
gt_semantic_path = gt_folder + "label-filt"
gt_instance_path = gt_folder + "instance-filt"

# # PVLFF
# result_folder = f"/home/yx/Data/yx/IROS2024/pvlff/scannet/{scene_name}" 
...
# our
# result_folder = "/sdf1/yx/exp/all/scannet/" + scene_idx + "/seg_wo_delete_query/v0" #ours
result_folder = "/sdf1/yx/exp/all/scannet/" + scene_idx + "/PanopticRecon/v0" #PanopticRecon
    ...
    def eval(self):
        ...
        for frame in tqdm(os.listdir(pre_semantic_path)):
            ...
            if scene_name == 'kitti360':
                ...
                # pred_semantic[gt_semantic==0] = 0
                # pred_instance[gt_semantic==0] = 0
